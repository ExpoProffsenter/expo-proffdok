// FASE 14.1.7.4 PREMIUM FAGIKONER ONLY: Bytter kun inline SVG-ikonene for egne sjekkpunkter til valgt premium ikonsett. Ingen funksjons-/database-/rapport-/garantiendringer.
...
const import_jsx_runtime = { jsx, jsxs, Fragment };
  ...
  var customChecklistTradeSvgMarkup = (trade = "") => {
    const text = String(trade || "").toLowerCase();
    const svgWrap = (body) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96"><defs><filter id="s" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="1.5" dy="2" stdDeviation="1.6" flood-color="#0f172a" flood-opacity=".22"/></filter><linearGradient id="metal" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f8fafc"/><stop offset=".55" stop-color="#cbd5e1"/><stop offset="1" stop-color="#7b8794"/></linearGradient></defs><g filter="url(#s)">${body}</g></svg>`;
    if (/rør|ror|vvs|sanit/.test(text)) return svgWrap(`<g transform="rotate(-38 48 48)"><path d="M26 17c8-7 20-7 29 0L42 30l9 9 13-13c7 10 6 23-3 32-8 8-20 10-30 5L16 80c-3 4-9 4-13 0s-4-9 0-13l17-16c-5-11-3-25 6-34z" fill="#e11d2e" stroke="#182033" stroke-width="4.2" stroke-linejoin="round"/><path d="M43 30l8 9" stroke="#111827" stroke-width="3" stroke-linecap="round" opacity=".35"/><path d="M31 56L15 72" stroke="#fff" stroke-width="5" stroke-linecap="round" opacity=".75"/><path d="M52 17L40 29" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity=".7"/><circle cx="16" cy="71" r="3.2" fill="#991b1b" opacity=".65"/></g>`);
    if (/tøm|tom|snekker/.test(text)) return svgWrap(`<g transform="rotate(34 48 48)"><path d="M43 39L65 74c3 5 2 11-2 13s-10 1-13-4L28 47z" fill="#a16207" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M32 45l10-7 5 8-10 7z" fill="#7c2d12" opacity=".35"/><path d="M28 17c18-8 35-3 45 13l-12 9c-8-9-17-12-30-8l8 13-15 9-14-24z" fill="url(#metal)" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M61 31c-8-7-17-9-27-6" stroke="#f8fafc" stroke-width="4" stroke-linecap="round" opacity=".7"/></g>`);
    if (/elektr/.test(text)) return svgWrap(`<path d="M56 5L18 55h28L37 91l42-55H51z" fill="#ffcc19" stroke="#f97316" stroke-width="5" stroke-linejoin="round"/><path d="M55 16L29 50h25l-7 25 23-32H47z" fill="#fff7ad" opacity=".45"/>`);
    if (/murer|flis|mur/.test(text)) return svgWrap(`<g transform="rotate(-20 48 48)"><path d="M18 65h54l10 15H8z" fill="url(#metal)" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M36 58L69 12c3-4 9-4 13 0s4 9 0 13L32 72z" fill="url(#metal)" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M35 60l20 16" stroke="#64748b" stroke-width="4" stroke-linecap="round"/><path d="M68 19L45 52" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity=".65"/></g>`);
    if (/maler|maling|sparkel/.test(text)) return svgWrap(`<g transform="rotate(24 48 48)"><path d="M40 47l22 9-12 31-22-9z" fill="#f97316" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M37 35l39 16 6-13c3-7 0-14-7-17l-11-5c-7-3-15 0-18 7z" fill="#f7b267" stroke="#182033" stroke-width="4"/><path d="M49 22l29 12" stroke="#fff7ed" stroke-width="4" stroke-linecap="round" opacity=".75"/><path d="M21 78c4 8 13 11 21 5l-17-7c-2-1-4 0-4 2z" fill="#ef4444" stroke="#182033" stroke-width="3" stroke-linejoin="round"/></g>`);
    if (/vent|luft/.test(text)) return svgWrap(`<circle cx="48" cy="48" r="12" fill="#4b5563" stroke="#182033" stroke-width="4"/><circle cx="48" cy="48" r="4" fill="#d1d5db"/><path d="M50 10c16 4 23 17 17 30-5 11-19 10-23 2-4-10-2-24 6-32z" fill="#5f6873" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M86 55c-9 14-23 17-33 9-9-8-4-20 6-23 11-3 23 3 27 14z" fill="#5f6873" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M26 80c-9-14-6-28 7-34 11-4 19 7 16 17-3 12-13 19-23 17z" fill="#5f6873" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M54 17c9 4 12 12 9 20" stroke="#cbd5e1" stroke-width="3" stroke-linecap="round" opacity=".65"/></g>`);
    return svgWrap(`<path d="M28 17h40v10h10v60H18V27h10z" fill="#f8fafc" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M34 11h28v19H34z" fill="#c98635" stroke="#182033" stroke-width="4" stroke-linejoin="round"/><path d="M36 47h27M36 61h27M36 75h27" stroke="#182033" stroke-width="4" stroke-linecap="round"/><path d="M23 47l5 5 8-11M23 61l5 5 8-11M23 75l5 5 8-11" stroke="#2563eb" stroke-width="4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><path d="M35 18h26" stroke="#fde68a" stroke-width="3" stroke-linecap="round" opacity=".75"/>`);
  };
