...
import {
  ...
  imageCats, roles, checklistAttachmentTradeOptions, customChecklistTradeOptions,
...
${appLink}`;
    ...
    if (isUnderleverandorView) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: UNDERENTREPRENOR_RUNTIME_STYLES }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { onClick: openImageLightboxFromClick, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
        ...
        tab === "firmaadmin" && isCompanyAdminUser && renderCompanyAdminPanel({
          currentCompanyName,
          companyAdminLoading,
  ...
  const { renderCompanyProfilePanel, renderCompanyAdminPanel } = createCompanyViewTools({
    Section,
    CollapsibleBlock,
    Brand,
    Grid,
  ...
  const { ProjectWarrantySetup, WarrantyPanel } = createWarrantyViewTools({
    Section,
    Grid,
    Input,
    Select,
