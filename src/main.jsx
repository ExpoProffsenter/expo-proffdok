// FASE 22 HOTFIX OPSJON ENTER: Enter i prisfeltet på en opsjon flytter fokus til neste opsjon eller oppretter en ny opsjon og fokuserer tittelfeltet. Direkte produksjonshotfix i main. Ingen SQL, RLS, Storage, Auth, e-post eller backendendring.
...
export default function SalesModule({
  ...
  function createEmptyOfferOption() {
    return {
  ...
  function handleOfferOptionAmountEnter(event, option, index) {
    if (event.key !== "Enter") return;

    event.preventDefault();

    const nextOption = offerForm.options[index + 1];
                      ...
                      {offerForm.options.map((option, index) => (
                        ...
                        >
                          ...
                          <input
                            ...
                            onKeyDown={(event) =>
                              handleOfferOptionAmountEnter(event, option, index)
                            }
                            placeholder="Beløp eks. mva."
                            inputMode="decimal"
                          />
