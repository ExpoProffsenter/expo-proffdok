// FASE 24K / 45B APPSTATISK KONFIG
...
export var EXPO_PROFFDOK_TERMS_VERSION = "1.1";
...
export var expoProffDokTermsSections = [
    {
      ...
      text: "Expo ProffDok er et skybasert dokumentasjons- og kvalitetssystem for prosjekter, bilder, sjekklister, FDV, produktdokumentasjon, overtagelse, garanti, tilbud og kommunikasjon. Tjenesten skal brukes på en forsvarlig og lovlig måte."
    },
    {
      title: "2. Tilgang og SoPro-forutsetning",
      text: "Tilgang til Expo ProffDok tilbys som del av Expo/SoPro-samarbeidet og forutsetter at virksomheten kjøper og benytter SoPro-produkter i relevant omfang. Expo kan be virksomheten dokumentere dette. Dersom forutsetningen ikke er oppfylt eller ikke kan dokumenteres ved forespørsel, kan Expo begrense, suspendere eller avslutte tilgangen til tjenesten."
    },
    {
      title: "3. Brukerens ansvar",
    ...
    {
      title: "4. Prosjektdokumentasjon og lokal lagring",
    ...
    {
      title: "5. Ingen garanti for permanent lagring",
    ...
    {
      title: "7. Sikkerhet og tilgang",
      text: "Brukeren skal holde innloggingsinformasjon konfidensiell og sørge for at kun personer med tjenstlig behov får tilgang til prosjekter og tilbud. Delingslenker, kundeportaltilganger og leverandør-/prisinnsyn skal brukes med forsiktighet."
    },
    {
      title: "8. Garanti og ansvar",
    ...
    {
      title: "10. Aksept av vilkår",
      text: "Ved å godkjenne vilkårene bekrefter brukeren å ha lest og forstått brukervilkår og personvernpunkter, inkludert SoPro-forutsetningen og plikten til å laste ned og lagre egne rapporter og dokumenter lokalt."
    }
  ];
