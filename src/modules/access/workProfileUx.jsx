  ...
  return (
    <>
      ...
      <style>{`
        ...
        @media(max-width:760px){#${HOST_ID}{width:100%!important;min-width:0!important;justify-self:stretch!important}.workProfileControl{width:100%!important;min-width:0;margin:8px 0 0}.workProfileButton{width:100%!important;max-width:none!important}.workProfileButton b{max-width:none;white-space:normal;overflow:visible;text-overflow:clip;line-height:1.2}.workProfileMenu{left:0;right:auto;width:100%;box-sizing:border-box}}
      `}</style>
    </>
  );
}
