...
function createProgressHelpBlock() {
  ...
  appendSection(block, '📅 Fremdriftsplan', [
    ...
    'Når du legger til en arbeidsoperasjon, åpnes den og du flyttes automatisk til riktig sted i planen.',
    ...
    'Ved ulagrede endringer følger Lagre fremdriftsplan med i synsfeltet, og du får varsel dersom du prøver å forlate planen uten å lagre.',
    'På mobil vises fremdriften som en enklere aktivitetsliste. Desktop er hovedflaten for full ukeoversikt.',
