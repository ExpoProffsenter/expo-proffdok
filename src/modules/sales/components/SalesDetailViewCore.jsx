...
// og gir alltid en direkte vei tilbake til befaringsnotatet når befaringen er gjennomført.
  ...
  summary,
    ...
    const publishedOfferDownloadLabel = hasUnpublishedOfferChanges
      ...
      : publishedVersionNumber
        ...
        : "Last ned tilbud PDF";
    const inspectionPhotoCount = selectedRequest.inspectionPhotos?.length || 0;
    ...
    const nextStepHelp = (() => {
      ...
      if (selectedRequest.status === "Befaring" && selectedRequest.nextStep === "Opprett tilbud") {
        return "Befaringen er registrert. Kontroller gjerne befaringsnotat og bilder før du bygger tilbudet fra samme sak.";
      }
      if (selectedRequest.status === "Befaring") {
        return "Registrer kundens ønsker, eksisterende forhold, målinger, observasjoner og bilder – eller gå direkte til tilbud dersom befaringsnotat ikke er nødvendig.";
      }
      if (selectedRequest.status === "Tilbud" && hasUnpublishedOfferChanges) {
              ...
              <div className="sales-hero-actions">
                ...
                {selectedRequest.status === "Befaring" ? (
                  ...
                  >
                    ...
                    {inspectionIsCompleted ? "Rediger tid/plan" : "Rediger befaring"}
                  </button>
                ) : null}
                ...
                selectedRequest.nextStep === "Opprett tilbud" ? (
                  <div
                    style={{
                      marginBottom: 16,
                      padding: "14px 16px",
                      border: hasInspectionContent ? "1px solid #8be4e8" : "1px solid #fed7aa",
                      borderRadius: 16,
                      background: hasInspectionContent ? "#e9fafb" : "#fff7ed",
                      lineHeight: 1.5,
                    }}
                  >
                    <strong>Befaringsgrunnlag:</strong>{" "}
                    {hasInspectionContent
                      ? `${inspectionPhotoCount} befaringsbilde${inspectionPhotoCount === 1 ? "" : "r"} lagret${inspectionPhotoCount ? "." : "; notater er lagret."}`
                      : "Ingen befaringsnotater eller bilder er lagret på saken ennå."}
                  </div>
                ) : null}
                {customerEmailFeedback ? (
                  <div
                    ...
                    <>
                      ...
                      {selectedRequest.nextStep === "Opprett tilbud" ? (
                        ...
                        >
                          <Ruler size={18} />
                          {hasInspectionContent
                            ? `Se/endre befaringsnotat · ${inspectionPhotoCount} bilde${inspectionPhotoCount === 1 ? "" : "r"}`
                            : "Legg til befaringsnotat/bilder"}
                        </button>
                      ) : (
                        <button
