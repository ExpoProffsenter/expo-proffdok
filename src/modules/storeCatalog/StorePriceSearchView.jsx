      ...
      <main className="priceSearchContent">
        <section className="priceSearchCard">
          ...
          <div className="priceSearchMeta" aria-live="polite">
            ...
            <small>Viser aktive varer fra siste aktiverte ERP-prisliste.</small>
          </div>
        </section>
