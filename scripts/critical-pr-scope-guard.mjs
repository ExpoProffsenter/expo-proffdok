...
const ALLOWED_DEMO_EXACT = new Set([
  ...
  // Smale, avtalte integrasjonspunkter for å montere Demo/Test og Hjelp.
  "src/modules/storeCatalog/systemAdminStoreCatalogUx.jsx",
  "src/modules/help/helpToolsCore.js",
]);
...
function runSelfTest() {
  ...
  assert(
    evaluateChangedFiles([
      ...
      "docs/architecture/FASE42L_DEMO_TEST_SUITE.md",
      "src/modules/storeCatalog/systemAdminStoreCatalogUx.jsx",
      "src/modules/help/helpToolsCore.js",
      "package.json",
      "vite.config.js",
    ]).length === 0,
    "Avtalte demo-/integrasjonsfiler skal være tillatt."
  );
